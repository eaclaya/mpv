...
function Plan({ name, price, description, href, features, featured = false }) {
    return (
        <section className={clsx('flex flex-col rounded-3xl px-6 sm:px-8', featured ? 'order-first bg-blue-600 py-8 lg:order-none' : 'lg:py-8')}>
            ...
            <p className="order-first text-5xl font-light tracking-tight text-white font-display">{price}</p>
...
export function Pricing() {
    return (
        <section id="pricing" aria-label="Pricing" className="py-20 bg-slate-900 sm:py-32">
            <Container>
                <div className="md:text-center">
                    <h2 className="text-3xl tracking-tight text-white font-display sm:text-4xl">
                        <span className="relative whitespace-nowrap">
                            <SwirlyDoodle className="absolute left-0 top-1/2 h-[1em] w-full fill-blue-400" />
                            <span className="relative">Precios accesibles,</span>
                        </span>{' '}
                        para todos nuestros clientes.
                    </h2>
                    <p className="mt-4 text-lg text-slate-400">
                        No importa el tamaño de tu negocio nuestro sistema se adaptara y crecera al mismo ritmo
                    </p>
                </div>
                <div className="grid max-w-2xl grid-cols-1 mt-16 -mx-4 gap-y-10 sm:mx-auto lg:-mx-8 lg:max-w-none lg:grid-cols-2 xl:mx-0 xl:gap-x-8">
                    <Plan
                        ...
                        features={[
                            ...
                            'Clientes ilimitados',
                            'Pago por sucursal ( 1 - 2 sucursales )',
                        ]}
                    />
                    <Plan
                        name="Mensual"
                        ...
                        features={[
                            ...
                            'Inventario ilimitado',
                            'Clientes ilimitados',
                            'Transferencias de inventario ilimitados',
                            'Pago por sucursal ( 3 - 20 sucursales)',
                        ]}
                    />
                </div>
            </Container>
